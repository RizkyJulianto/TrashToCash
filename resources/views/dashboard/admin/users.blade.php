                        ...
                        <tbody>
                            ...
                            @foreach ($users as $data)
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ rtrim(rtrim(number_format($data->point, 2), '0'), '.') }}
                                    </td>
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-4">
                                            <form id="delete-form-{{ $data->id }}"
                                                action="{{ route('delete.data-users', $data->id) }}" method="post"
                                                onsubmit="confirmDelete(event,this);">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="py-2 px-3 flex gap-x-2 border border-red-500 items-center text-sm font-medium text-center text-red-500 focus:outline-none bg-white rounded-lg  hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
