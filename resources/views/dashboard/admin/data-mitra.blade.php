            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md rounded-md overflow-hidden">
                ...
                <div
                    ...
                    <div class="w-full md:w-1/2">
                         <form class="flex items-center w-full md:w-[60%] lg:w-[70%]">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="search"
                                    placeholder="Cari data berdasarkan nama" name="search"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="p-4 font-semibold">Nama Mitra</th>
                                <th scope="col" class="p-4 font-semibold">Email</th>
                                <th scope="col" class="p-4 font-semibold">Alamat</th>
                                <th scope="col" class="p-4 font-semibold">Jenis Mitra</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($user as $data)
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="bg-primary-100 text-primary-800 text-base  px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ $data->email }}</span>
                                    </td>
                                    <td class="px-4 py-3">{{ $data->address }}</td>
                                    <td class="px-4 py-3">{{ $data->partner }}</td>
                                    <td class="px-4 py-3 font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <button type="button"
                                                ...
                                                <a
                                                    href="{{ route('detail.data-mitra', $data->id) }}">Preview</a>
                                            </button>
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Menampilkan
                        <span
                            class="font-semibold text-gray-900 dark:text-white">{{ $user->firstItem() }}</span>
                        sampai
                        <span
                            class="font-semibold text-gray-900 dark:text-white">{{ $user->lastItem() }}</span>
                        dari
