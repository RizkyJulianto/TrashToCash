<x-admin-app-layout>
    ...
    <section class=" dark:bg-gray-900">
        ...
        <form action="{{ route('add.data-tps') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name_tps" id="name_tps"
                            ...
                            placeholder="Masukan Nama TPS" value="{{ old('name_tps') }}">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="address" id="address"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Masukan Alamat" value="{{ old('address') }}">
