<x-user-app-layout>
    ...
    <section class=" dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="{{ route('add.trash-submission') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="number" name="weight" id="weight"
                            ...
                            placeholder="Masukan berat sampah" value="{{ old('weight') }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="description" rows="8" name="description"
                            ...
                            placeholder="Your description here" value="{{ old('description') }}"></textarea>
