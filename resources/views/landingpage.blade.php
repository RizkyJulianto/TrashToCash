...
<body class="antialiased ">
    <header class="header relative py-7 px-6" id="Home">
        ...
        <section class="home h-screen scroll-mt-28">
            ...
            <div class="home-textbox mt-40 lg:mt-32 px-10 flex flex-col gap-y-5 md:max-w-[700px] ">
                <div class="textbox-title">
                    <h2
                        class="text-white/90 font-bold font-roboto text-4xl md:text-6xl leading-10 md:leading-16 lg:text-5xl">
                        Ubah Sampah Jadi Peluang, Bantu Lingkungan Sekaligus Dapatkan <span class="text-yellow-400">Reward!</span>
                    </h2>
                </div>
            ...
            <div
                class="card-home flex flex-col md:flex-row max-md:items-center gap-y-5 gap-x-5 w-full justify-center px-10 md:px-7 mt-40 md:mt-[260px] lg:mt-24">
                <div
        ...
        <section class="about py-12 w-full flex flex-col items-center scroll-mt-28" id="About">
            <div class="section-title text-center flex flex-col gap-y-3 items-center">
            ...
            <div class="about-content flex flex-col items-center px-6 gap-y-10 gap-x-12 mt-20 lg:flex-row">
                <div class="about-left-col max-md:px-4">
                    <img src="{{ asset('images/tentang-image.png') }}" alt="" class="lg:w-[450px] md:w-[670px]" />
                </div>
                <div class="about-right-col max-w-[400px] md:max-w-[630px] lg:max-w-[600px] max-md:px-4">
                    <div class="title">
                        <h2
        ...
        <section class="service py-20 px-7 lg:px-10 w-full scroll-mt-28" id="Service">
            ...
            <div class="service-content mt-12 flex flex-col lg:flex-row gap-x-7 gap-y-5">
                <div
                    ...
                    <div class="description-card mt-2">
                        <p
                            class="font-fredoka opacity-80 font-light text-xl lg:text-base lg:max-w-[400px] text-justify">
        ...
        <section class="work px-7 lg:px-10 py-20 w-full relative z-0 scroll-mt-28" id="Works">
            ...
            <div class="works-content flex flex-col lg:flex-row gap-x-7 gap-y-10 mt-12 relative items-center">
                <div
        ...
        <section class="testimoni flex flex-col items-center w-full py-20 scroll-mt-28" id="Review">
            ...
            <div class="testimoni-content flex flex-col gap-y-5 lg:flex-row justify-center gap-x-7 px-10 mt-12">
                <div
        ...
        <section class="faq flex flex-col px-10 py-20 w-full scroll-mt-28" id="FAQ">
            ...
            <div class="faq-content flex flex-col items-center w-full mt-12 gap-y-5">
                <div
                        ...
                        <form action=""
                            ...
                            <div
                                ...
                                <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" class="text-white/80">
                                        <path fill="currentColor"
